...
struct PrismTests {
    ...
    func themeURLs() {
        let version = "1.29.0"
        #expect(Prism.Theme.default.cssURL(cdnVersion: version) == "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism.min.css")
        #expect(Prism.Theme.okaidia.cssURL(cdnVersion: version) == "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/themes/prism-okaidia.min.css")
    }
    ...
    func pluginURLs() {
        ...
        #expect(lineNumbers.scriptURL(cdnVersion: version) == "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/plugins/line-numbers/prism-line-numbers.min.js")
        #expect(lineNumbers.cssURL(cdnVersion: version) == "https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/plugins/line-numbers/prism-line-numbers.min.css")
    }
